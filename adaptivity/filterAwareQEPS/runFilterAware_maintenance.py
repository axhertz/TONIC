...
if dataset == "reduced_data":
	with open("../../dataShift/reducedData/filterAwareQEPS/filter_aware_qeps_reduced.pkl","rb") as pretrained:
...
pattern = re.compile("""(\((.)*?\))""")
pre_out_cnt = 0
file_list = glob.glob("../../feedback/fullData/*.sql")
file_list = []
...
file_list = file_list[:int(fraction*len(file_list))]
...
with open("filter_aware_qeps.pkl","wb") as file:
