...
if path.exists("plain_qeps_gamma_{}.pkl".format(plan_cache.gamma)):
	with open("plain_qeps_gamma_{}.pkl".format(plan_cache.gamma),"rb") as fb:
		plan_cache = pickle.load(fb)

elif path.exists("plain_qeps_reduced_gamma_{}.pkl".format(plan_cache.gamma)):
	with open("plain_qeps_reduced_gamma_{}.pkl".format(plan_cache.gamma),"rb") as fb:
		plan_cache = pickle.load(fb)
else:
	print("something went wrong could not find pretrained QEPS")
	exit()
...
with open("plain_qeps_gamma_{}.pkl".format(plan_cache.gamma),"wb") as file:
	pickle.dump(plan_cache,file)

#print("time lost", time_lost, "time_out_cnt", time_out_cnt)
