...
if path.exists("strict_plain_qeps_gamma_{}.pkl".format(plan_cache.gamma)):
	with open("strict_plain_qeps_gamma_{}.pkl".format(plan_cache.gamma),"rb") as fb:
		plan_cache = pickle.load(fb)

elif path.exists("strict_plain_qeps_half_gamma_{}.pkl".format(plan_cache.gamma)):
	with open("strict_plain_qeps_half_gamma_{}.pkl".format(plan_cache.gamma),"rb") as fb:
		plan_cache = pickle.load(fb)
else:
...
with open("strict_plain_qeps_gamma_{}.pkl".format(plan_cache.gamma),"wb") as file:
