...
with open("plain_trace_1.txt", "w") as ft:
	print("create trace")
...
for file in file_list:
	with open("plain_trace_1.txt", "a+") as ft:
		ft.write("start\n")
	...
	for n_rel, rels in enumerate(rel_matches):
		...
		if rels[0] != root_rel:
			...
			if feedback_list[n_rel][0] + feedback_list[n_rel][1] > 0: 
				...
				with open("plain_trace_1.txt", "a+") as ft:
					ft.write("reference_branch updateKey {} {} {} \n".format("#"+insert_key.split("/")[-1], feedback_list[n_rel][0],feedback_list[n_rel][1]))
...
with open("plain_qeps.pkl","wb") as file:
	pickle.dump(plan_cache,file)

print("finished plain_trace_1.txt")
