...
with open("sel_aware_trace_1.txt", "w") as ft:
	print("create trace")
...
for file in feedback_list:
	with open("sel_aware_trace_1.txt", "a+") as ft:
		ft.write("start\n")
	...
	for n_rel, rels in enumerate(rel_matches):
		...
		if rels[0] != root_rel:
			...
			if len(rels) == 2:
				...
				with open("sel_aware_trace_1.txt", "a+") as ft:
					ft.write("dummy_branch = reference_branch getNext {} {} \n".format("#"+insert_key.split("/")[-1], selectivity))
				with open("sel_aware_trace_1.txt", "a+") as ft:
					ft.write("dummy_branch getRecommended\n")
			if feedback_list[n_rel][0] + feedback_list[n_rel][1] > 0: 
				...
				with open("sel_aware_trace_1.txt", "a+") as ft:
					ft.write("reference_branch updateKey {} {} {} {} {} \n".format("#"+insert_key.split("/")[-1], feedback_list[n_rel][0],feedback_list[n_rel][1] , selectivity,  skip_bound))
...
with open("selAware_qeps.pkl","wb") as file:
	pickle.dump(plan_cache,file)


print("finished sel_aware_trace_1.txt")
