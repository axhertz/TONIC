...
with open("sel_aware_trace_2.txt", "w") as ft:
	print("create trace")
...
with open("selAware_qeps.pkl","rb") as file:
...
for file in feedback_list:
	with open("sel_aware_trace_2.txt", "a+") as ft:
		ft.write("start\n")
...
print("finished sel_aware_trace_2.txt")
