...
parser.add_argument("dropped_idx", type = str)
args = parser.parse_args()

dropped_idx = args.dropped_idx
...
with open("plain_qeps_del_index.pkl","rb") as file:
...
#with open("index_recommendtion.txt","a+" ) as file:
#	file.write(str(dropped_idx) + " " + str(time_lost) +"\n"

#print(time_lost)
with open("timediff_gamma.pkl", "rb") as fb:
	time_diff_dict = pickle.load(fb)
print(str(dropped_idx) + " " + str(round(time_lost-time_diff_dict[plan_cache.gamma],2))+"s") 
