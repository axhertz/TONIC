...
for q in queries_sort:
	file_list.append("../../../feedback/reducedData/{}".format(q))
		...
		with open(file,"r") as f:
			...
			if not hit_1:
				with open("explicit/"+ file.split("/")[-1]) as query_file:
						...
						with open("../../../feedback/halfData/"+file.split("/")[-1],"r+") as clean_file:
		...
		with open(file,"r") as f:
			if not feedback_alt in f.read():
				...
				with open("explicit/"+ file.split("/")[-1]) as query_file:
					...
					with open("../../../feedback/reducedData/"+file.split("/")[-1],"r+") as clean_file:
						content = clean_file.read()
						clean_file.seek(0, 0)
