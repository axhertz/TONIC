...
if dataset == "half_data":
	with open("../../halfData/selAwareQEPS/strict_sel_qeps_half.pkl","rb") as pretrained:
...
if dataset == "half_data":
	with open("strict_sel_qeps_half.pkl","wb") as file:
		pickle.dump(plan_cache,file)
else:
	with open("strict_sel_qeps.pkl","wb") as file:
		pickle.dump(plan_cache,file)
