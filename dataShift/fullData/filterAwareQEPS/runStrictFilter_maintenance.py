...
if dataset == "half_data":
	with open("../../halfData/filterAwareQEPS/strict_filter_qeps_half.pkl","rb") as pretrained:
...
if dataset == "half_data":
	with open("strict_filter_qeps_half.pkl","wb") as file:
		pickle.dump(plan_cache,file)
else:
	with open("strict_filter_qeps.pkl","wb") as file:
		pickle.dump(plan_cache,file)
