...
if dataset == "half_data":
	with open("../../halfData/plainQEPS/strict_plain_qeps_half.pkl","rb") as pretrained:
...
if dataset == "half_data":
	with open("strict_plain_qeps_half.pkl","wb") as file:
		pickle.dump(plan_cache,file)
else:
	with open("strict_plain_qeps.pkl","wb") as file:
		pickle.dump(plan_cache,file)
